import { echartOptionProfixHandle, PublicConfigClass } from '@/utils'
import { MapBaseConfig } from './index'
import { chartInitConfig } from '@/constants/index'
import { CreateComponentType } from '@/typings/design.d'
