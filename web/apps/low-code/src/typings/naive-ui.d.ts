declare namespace NaiveUI {
  ...
  type TableColumnCheck = import('@hl/hooks').TableColumnCheck;
  type TableDataWithIndex<T> = import('@hl/hooks').TableDataWithIndex<T>;
  type FlatResponseData<T> = import('@hl/axios').FlatResponseData<T>;
  ...
  type NaiveTableConfig<A extends TableApiFn> = Pick<
    import('@hl/hooks').TableConfig<A, GetTableData<A>, TableColumn<TableDataWithIndex<GetTableData<A>>>>,
