...
declare module "@elegant-router/types" {
  ...
  export type LastLevelRouteKey = Extract<
    ...
    | "community"
    | "design"
    | "design_modules_design-configs_animation-config"
    | "design_modules_design-configs_component-config"
    | "design_modules_design-configs_data-source-config"
    | "design_modules_design-configs_design-page-config"
    | "design_modules_design-configs_event-config"
    | "design_modules_design-configs"
    | "design_modules_design-datasource"
    | "design_modules_design-edit"
    | "design_modules_design-filter"
    | "design_modules_design-header"
    | "design_modules_design-history"
    | "design_modules_design-layout"
    | "design_modules_design-material"
    | "design_modules_design-menu"
    | "home"
    | "manage_api"
    | "manage_log"
    | "manage_menu"
