<template>
  <n-breadcrumb v-if="themeStore.header.breadcrumb.visible">
    ...
    <n-breadcrumbItem v-for="item in routeStore.breadcrumbs" :key="item.key">
      <n-dropdown v-if="item.options?.length" :options="item.options" @select="handleClickMenu">
