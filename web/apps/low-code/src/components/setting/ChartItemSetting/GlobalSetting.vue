<template>
  ...
  <collapse-item v-if="xAxis" name="X轴">
    ...
    <setting-item-box name="分割线">
      ...
      <setting-item name="类型">
        <n-select v-model:value="xAxis.splitLine.lineStyle.type" size="small"
          :options="axisConfig.splitLint.lineStyle.type"></n-select>
      </setting-item>
    </setting-item-box>
  </collapse-item>
  ...
  <collapse-item v-if="yAxis" name="Y轴">
    ...
    <setting-item-box name="分割线">
      ...
      <setting-item name="类型">
        <n-select v-model:value="yAxis.splitLine.lineStyle.type" size="small"
          :options="axisConfig.splitLint.lineStyle.type"></n-select>
      </setting-item>
    </setting-item-box>
  </collapse-item>
...
import { GlobalThemeJsonType, axisConfig, legendConfig } from '@/constants/index'
import { CollapseItem, SettingItemBox, SettingItem, GlobalSettingPosition } from '@/components/setting/ChartItemSetting'
...
const chartEditStore = useDesignEditStore()
