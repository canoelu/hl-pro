<template>
  <n-modal v-model:show="visible" :title="title" preset="card" class="w-480px">
    <n-tree v-model:checked-keys="buttonIds" :data="tree" key-field="id" default-expand-all block-line cascade checkable
      expand-on-click virtual-scroll class="h-280px" />
    <template #footer>
      <n-space justify="end">
