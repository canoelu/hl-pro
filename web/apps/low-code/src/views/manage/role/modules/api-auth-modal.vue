<template>
  <n-modal v-model:show="visible" :title="title" preset="card" class="w-480px">
    <n-tree v-model:checked-keys="apiIds" :data="tree" key-field="id" label-field="summary" default-expand-all
      block-line cascade checkable expand-on-click virtual-scroll class="h-280px" />
    <template #footer>
      <n-space justify="end">
