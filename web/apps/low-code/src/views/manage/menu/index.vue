<template>
  <div ref="wrapperRef" class="flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    <n-card :title="$t('page.manage.menu.title')" :bordered="false" size="small" class="sm:flex-1-hidden card-wrapper">
      ...
      <menu-operate-modal v-model:visible="visible" :operate-type="operateType" :row-data="editingData"
    ...
    },
    {
      ...
      render: row => (
        <div class="flex-center justify-end gap-8px">
          {row.menuType === '1' && (
            <n-button type="primary" ghost size="small" onClick={() => handleAddChildMenu(row)}>
              {$t('page.manage.menu.addChildMenu')}
            </n-button>
          )}
          <n-button type="primary" ghost size="small" onClick={() => handleEdit(row)}>
            {$t('common.edit')}
          </n-button>
