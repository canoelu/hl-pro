...
<template>
  <n-modal v-model:show="visible" :title="title" preset="card" class="w-800px">
      ...
      <n-form ref="formRef" :model="model" :rules="rules" label-placement="left" :label-width="100">
        <n-grid responsive="screen" item-responsive>
          ...
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.menuName')" path="menuName">
            <n-input v-model:value="model.menuName" :placeholder="$t('page.manage.menu.form.menuName')" />
          </NFormItemGi>
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.routeName')" path="routeName">
            <n-input v-model:value="model.routeName" :placeholder="$t('page.manage.menu.form.routeName')" />
          </NFormItemGi>
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.routePath')" path="routePath">
            <n-input v-model:value="model.routePath" disabled :placeholder="$t('page.manage.menu.form.routePath')" />
          </NFormItemGi>
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.pathParam')" path="pathParam">
            <n-input v-model:value="model.pathParam" :placeholder="$t('page.manage.menu.form.pathParam')" />
          </NFormItemGi>
          ...
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.i18nKey')" path="i18nKey">
            <n-input v-model:value="model.i18nKey" :placeholder="$t('page.manage.menu.form.i18nKey')" />
          </NFormItemGi>
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.order')" path="order">
            <n-inputNumber v-model:value="model.order" class="w-full" :placeholder="$t('page.manage.menu.form.order')" />
          </NFormItemGi>
          ...
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.icon')" path="icon">
            <template v-if="model.iconType === '1'">
              <n-input v-model:value="model.icon" :placeholder="$t('page.manage.menu.form.icon')" class="flex-1">
                <template #suffix>
          ...
          <NFormItemGi span="24 m:12" :label="$t('page.manage.menu.href')" path="href">
            <n-input v-model:value="model.href" :placeholder="$t('page.manage.menu.form.href')" />
          </NFormItemGi>
          ...
          <NFormItemGi span="24" :label="$t('page.manage.menu.query')">
            ...
            >
              <template #action="{ index, create, remove }">
                <n-space class="ml-12px">
                  <n-button size="medium" @click="() => create(index)">
                    <icon-ic:round-plus class="text-icon" />
                  </n-button>
                  <n-button size="medium" @click="() => remove(index)">
