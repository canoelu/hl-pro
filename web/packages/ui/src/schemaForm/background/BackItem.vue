<template>
  <div class="flex flex-col flex-nowrap w-full">
    <n-select v-model:value="selectOption" :options="options" class="pb-2.5 mt-1" />
    <n-color-picker v-if="selectOption === 'backgroundColor'" v-model:value="backgroundColor.backgroundColor"
      class="mt-1" :swatches="GlobalColorSwatches" @update:value="changeBackgroundColor" />
